      ...
      <div className="modal modal--visibility">
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            <h2 className="modal__header">Создать новость</h2>
            <form className="modal__form-news form-news">
              <label className="form-news__label" htmlFor="news-title">Тема</label>
              <input ref={titleRef} className="form-news__input" id="news-title" type="text" autoComplete="off" placeholder="Введите текст" />
              <label className="form-news__label" htmlFor="news-content">Текст</label>
              <textarea ref={contentRef} className="form-news__input form-news__input--textarea" id="news-content" autoComplete="off" placeholder="Введите текст"></textarea>
              <label className="form-news__label" htmlFor="news-link">Ссылка</label>
              <input ref={imageRef} className="form-news__input form-news__input--link" id="news-link" type="text" autoComplete="off" placeholder="Вставьте ссылку" />
              ...
              <div className="modal__button-container">
                <button className="button button--active" type="submit" onClick={handleCreateNewsSubmit}>Сохранить</button>
